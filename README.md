...
- **From Executable**: Download `RE-PLAY.exe` from Releases and double-click to play (or, [⬇ Download RE:PLAY (Windows)](https://github.com/nickynault/RE-PLAY/releases/download/v0.1.0/RE-PLAY_v0.1.0.exe)
)
